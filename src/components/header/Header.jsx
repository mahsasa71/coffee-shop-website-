...
const navigate = useNavigate();
  ...
  return (
    <>
      ...
      <header className="fixed z-50 top-9 right-0 left-0 hidden md:flex items-center justify-between w-[98%] lg:w-[90%] h-24 rounded-3xl mx-auto px-5 lg:px-10 bg-black/50 backdrop-blur-[6px]">
        <div className="flex justify-between w-full mr-24">
          <nav className="flex h-14 items-center gap-x-6 lg:gap-x-9">
            <div className="shrink-0">
              <img src="/imges/app-logo.png" alt="Logo" />
            </div>
            <ul className="flex h-full gap-x-5 lg:gap-x-9 text-xl text-gray-300 tracking-tightest *:leading-[56px]">
              ...
              <li className="relative group">
                ...
                <div className="absolute top-full opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all delay-75 w-52 bg-white p-6 space-y-4 dark:bg-zinc-700 text-zinc-700 dark:text-white text-base rounded-2xl border-t-[3px] border-t-orange-300 shadow-normal">
          ...
          <div className="flex items-center gap-x-4 lg:gap-x-5 text-orange-200">
      ...
      <div className={`nav p-3 overflow-y-auto fixed top-0 bottom-0 w-64 h-full md:hidden bg-white dark:bg-zinc-700 z-50 transition-all ${mobileNavOpen ? "right-0" : "-right-64"}`}>
        ...
        <ul className="*:pr-2.5 space-y-6 text-zinc-600 dark:text-white">
          <li>
            ...
            <div className="submenu flex flex-col gap-2 pl-8 mt-3">
              <a href="#" onClick={preventLink}>قهوه ویژه</a>
