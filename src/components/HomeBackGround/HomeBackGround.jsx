...
export default function HomeBackGround() {
  return (
   <section className="home relative h-[200px] xs:h-auto xs:aspect-[2/1] md:aspect-auto md:pl-20 bg-[url('../imges/headerBgMobile.webp')] md:bg-[url('../imges/headerBgDesktop.webp')] bg-cover bg-center">

      <div className="container relative overflow-hidden h-full md:min-h-screen flex justify-end items-center">
        <div className="text-white">
          <h2 className="font-Morabba font-bold text-2xl lg:text-6xl/[62px] mb-0.5 md:mb-2">
            قهوه ی عربیکا تانزانیا
          </h2>
          <span className="font-Morabba font-light text-xl lg:text-5xl/[64px]">
            یک فنجان بالانس!
          </span>
          <span className="block w-[100px] h-px md:h-0.5 bg-orange-300 my-3 md:my-2"></span>
          <p className="max-w-[201px] md:max-w-[460px] text-xs lg:text-2xl">
